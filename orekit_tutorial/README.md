...
| 章节 | 文档 | 代码示例 | 内容 |
|------|------|---------|------|
| **01** | [快速开始](docs/01_快速开始.md) | [01_quick_start.py](examples/01_quick_start.py) | Orekit 初始化、创建第一个轨道 |
| **02** | [核心概念](docs/02_核心概念.md) | — | 时间系统、坐标系、轨道六要素 |
| **03** | [轨道创建与表示](docs/03_轨道创建与表示.md) | [03_orbit_creation.py](examples/03_orbit_creation.py) | KeplerianOrbit/CircularOrbit/CartesianOrbit 与互转 |
| **04** | [数值传播与力学模型](docs/04_数值传播与力学模型.md) | [04_keplerian_propagation.py](examples/04_keplerian_propagation.py) [04_numerical_propagation.py](examples/04_numerical_propagation.py) | 开普勒传播、数值传播、多种力学模型对比 |
| **05** | [力学模型详解](docs/05_力学模型.md) | — | 力学模型详解（参考第04章代码） |
| **06** | [坐标系转换](docs/06_坐标系转换.md) | [06_frame_transform.py](examples/06_frame_transform.py) | GCRF/ITRF/ENU 坐标系转换 |
| **07** | [TLE解析与传播](docs/07_TLE解析与传播.md) | [07_tle_propagation.py](examples/07_tle_propagation.py) | TLE 解析、SGP4/SDP4 传播 |
| **08** | [卫星相对运动](docs/08_卫星相对运动.md) | [08_relative_motion.py](examples/08_relative_motion.py) | Hill 坐标系、相对状态计算 |
